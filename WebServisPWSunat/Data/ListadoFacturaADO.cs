...
{
    public class ListadoFacturaADO
    {
        public List<DocumentoElectronicosENT> GetListarlistaFactura()
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_listado_visor_web_factura", cnx);
